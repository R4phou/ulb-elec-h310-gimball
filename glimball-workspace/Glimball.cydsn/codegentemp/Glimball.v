...
module top ;
	...
	wire [0:0] tmpOE__JOY_ADC_net;
	wire [0:0] tmpFB_0__JOY_ADC_net;
	wire [0:0] tmpIO_0__JOY_ADC_net;
	wire [0:0] tmpINTERRUPT_0__JOY_ADC_net;
	electrical [0:0] tmpSIOVREF__JOY_ADC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ffe56b0a-e7be-44b2-8ea2-c9407afc0146"),
		  ...
		  .input_buffer_sel(2'b00))
		JOY_ADC
		 (.oe(tmpOE__JOY_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__JOY_ADC_net[0:0]}),
		  .analog({Net_110}),
		  .io({tmpIO_0__JOY_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__JOY_ADC_net),
		  .interrupt({tmpINTERRUPT_0__JOY_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__JOY_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
