...
void    ACC_Y_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the ACC_Y_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(ACC_Y__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in ACC_Y_SetInterruptMode() function.
     *  @{
     */
        #define ACC_Y_INTR_NONE      (uint16)(0x0000u)
        #define ACC_Y_INTR_RISING    (uint16)(0x0001u)
        #define ACC_Y_INTR_FALLING   (uint16)(0x0002u)
        #define ACC_Y_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define ACC_Y_INTR_MASK      (0x01u) 
#endif /* (ACC_Y__INTSTAT) */
...
/* SIO registers */
#if defined(ACC_Y__SIO_CFG)
    #define ACC_Y_SIO_HYST_EN        (* (reg8 *) ACC_Y__SIO_HYST_EN)
    #define ACC_Y_SIO_REG_HIFREQ     (* (reg8 *) ACC_Y__SIO_REG_HIFREQ)
    #define ACC_Y_SIO_CFG            (* (reg8 *) ACC_Y__SIO_CFG)
    #define ACC_Y_SIO_DIFF           (* (reg8 *) ACC_Y__SIO_DIFF)
#endif /* (ACC_Y__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define ACC_Y_0_INTTYPE_REG 		(* (reg8 *) ACC_Y__0__INTTYPE)
#endif /* (ACC_Y__INTSTAT) */
