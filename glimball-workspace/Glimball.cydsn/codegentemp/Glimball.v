...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("eebae605-8fac-4613-8b0e-5f2b3f270e9c/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("c94758d6-fb68-4040-802f-719a2efcef02/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("c94758d6-fb68-4040-802f-719a2efcef02/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d7dc968f-45f5-436a-a024-6af615de0245"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("38c9a588-0362-4673-881f-2820097302e9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c0540ba2-d708-4101-9ca0-b94843b2f6d4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("aa5a8075-3ba0-42ef-b77b-2a0d41ffe4d3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("01a604b3-8155-4fc0-a738-c87cd17cf9a4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b991c057-a702-4972-bbb2-0deb213be472"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9237f950-6aa6-42d4-892d-2105843a110a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ab138086-cdff-4008-be1d-fa1f5918c295"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c15d83fa-0402-4b75-9df0-4838befcaf08"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("173f4ff0-3dff-4afc-80f2-7b949aa1459a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9057ebcc-7a71-4d38-9c85-b4ddc3d4698f"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("68782ef7-0362-4977-889a-30009078b345"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ba8d83d1-0a34-4f6a-b950-0120490550a7"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("4d6000af-460a-4e40-848b-8aac0cb6a5c3"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(24),
		  .period("0"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("66465a7a-e38e-442b-a806-cf4a1444229a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Z_ADC_net;
	wire [0:0] tmpFB_0__Z_ADC_net;
	wire [0:0] tmpIO_0__Z_ADC_net;
	wire [0:0] tmpINTERRUPT_0__Z_ADC_net;
	electrical [0:0] tmpSIOVREF__Z_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("62476ba1-e5b9-4fdc-9e9b-58e5234f3047"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Z_ADC
		 (.oe(tmpOE__Z_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Z_ADC_net[0:0]}),
		  .analog({Net_55}),
		  .io({tmpIO_0__Z_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__Z_ADC_net),
		  .interrupt({tmpINTERRUPT_0__Z_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Z_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Y_ADC_net;
	wire [0:0] tmpFB_0__Y_ADC_net;
	wire [0:0] tmpIO_0__Y_ADC_net;
	wire [0:0] tmpINTERRUPT_0__Y_ADC_net;
	electrical [0:0] tmpSIOVREF__Y_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("ffe56b0a-e7be-44b2-8ea2-c9407afc0146"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Y_ADC
		 (.oe(tmpOE__Y_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Y_ADC_net[0:0]}),
		  .analog({Net_54}),
		  .io({tmpIO_0__Y_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__Y_ADC_net),
		  .interrupt({tmpINTERRUPT_0__Y_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Y_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__X_ADC_net;
	wire [0:0] tmpFB_0__X_ADC_net;
	wire [0:0] tmpIO_0__X_ADC_net;
	wire [0:0] tmpINTERRUPT_0__X_ADC_net;
	electrical [0:0] tmpSIOVREF__X_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("20d855cb-ed0d-4f87-aacc-776e19fb3a61"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		X_ADC
		 (.oe(tmpOE__X_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__X_ADC_net[0:0]}),
		  .analog({Net_53}),
		  .io({tmpIO_0__X_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__X_ADC_net),
		  .interrupt({tmpINTERRUPT_0__X_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__X_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PIN_DAC_net;
	wire [0:0] tmpFB_0__PIN_DAC_net;
	wire [0:0] tmpIO_0__PIN_DAC_net;
	wire [0:0] tmpINTERRUPT_0__PIN_DAC_net;
	electrical [0:0] tmpSIOVREF__PIN_DAC_net;

	cy_psoc3_pins_v1_10
		#(.id("012a8844-9252-4189-830e-7fead1a75bf7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_DAC
		 (.oe(tmpOE__PIN_DAC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_DAC_net[0:0]}),
		  .analog({Net_80}),
		  .io({tmpIO_0__PIN_DAC_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_DAC_net),
		  .interrupt({tmpINTERRUPT_0__PIN_DAC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_DAC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
